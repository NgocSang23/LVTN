...
@section('content')
    ...
    <div class="container py-4">
        ...
        <ul class="nav nav-tabs mb-4">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('user.history_define_essay') }}">Các khái niệm - tự luận đã học</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('user.history_multiple_choice') }}">Các bài kiểm tra đã làm</a>
            </li>
        </ul>
