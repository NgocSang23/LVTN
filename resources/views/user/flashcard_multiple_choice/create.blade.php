        ...
        <div class="card shadow p-4" style="border-radius: 12px;">
            <form id="createTestForm" method="POST" action="{{ route('flashcard_multiple_choice.store') }}">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <label for="bkt_thoigian" class="form-label" style="font-weight: 500;">Thời Gian Làm Bài (phút)</label>
                        <input type="number" class="form-control" id="bkt_thoigian" name="test_time" style="border-radius: 8px;">
                        @error('test_time')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div id="questions">
                    <div class="question-group mb-4 p-3 border rounded bg-light" style="border-radius: 8px;">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="option_content[0][]" placeholder="Phương án A" style="border-radius: 8px;">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="option_content[0][]" placeholder="Phương án B" style="border-radius: 8px;">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="option_content[0][]" placeholder="Phương án C" style="border-radius: 8px;">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="option_content[0][]" placeholder="Phương án D" style="border-radius: 8px;">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <button type="button" id="addQuestion" class="btn btn-outline-primary" style="border-radius: 8px; padding: 8px 20px;">+ Thêm Câu Hỏi</button>
                    <button type="submit" class="btn btn-primary text-white" style="border-radius: 8px; padding: 8px 20px;">Tạo và Ôn luyện</button>
                </div>
            </form>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateCardNumbers() {
                document.querySelectorAll(".question-group").forEach((card, index) => {
                    card.querySelector(".card-number").textContent = `Câu Hỏi ${index + 1}`;
                });
            }
            ...
            addQuestionButton.addEventListener('click', function() {
                ...
                newQuestion.innerHTML = `
                    <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0" style="font-weight: 600;">Câu Hỏi ${questionCount + 1}</h5>
                            <button type="button" class="btn btn-sm btn-danger remove-card" style="border-radius: 6px;">Xóa</button>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" style="font-weight: 500;">Nội dung câu hỏi</label>
                            <textarea class="form-control" name="multiple_question[]" rows="2" style="border-radius: 8px;"></textarea>
